...
class SerenattoBot:
    def __init__(self):
        ...
        collection_name = 'documentos_agro'
    ...
    def carregar_pdf(self):
        with TemporaryDirectory() as tmpdir:
            pdf_path = "documentos/doc_info_agricultura.pdf"
            text = ""
            ...
            self.chat_engine = self.document_index.as_chat_engine(
                ...
                llm=self.llms,
                memory=memory,
                system_prompt='''Você é especialista em agricultura. Responda de forma simpática e natural sobre sementes, preparo de solo.'''
            )
